...
jQuery.Huifocusblur = function(obj) {
	$(obj).focus(function() {$(this).addClass("fjQuery.Huifoldocus").removeClass("inputError");});
...
/*返回顶部*/
var $backToTopEle=$('<a href="javascript:void(0)" class="iconfont icon-xiangshang toTop" title="返回顶部" alt="返回顶部"></a>').appendTo($("body")).click(function(){
